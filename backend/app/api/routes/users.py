...
def update_user_me(
    *, session: SessionDep, user_in: UserUpdateMe, current_user: CurrentUser
    ...
    if user_in.email:
        existing_user = UserRepository.get_user_by_email(session=session, email=user_in.email)
...
def update_user(
    *,
    ...
    db_user = UserRepository.update_user(session=session, db_user=db_user, user_in=user_in)
    return db_user
